...
export function createIncidentCase(now?: string, id?: string, storeSignature?: string, storeName?: string): import("./types").IncidentCase;
...
export function removeCasePin(incident: import("./types").IncidentCase, target: import("./types").CasePin | string, now?: string): import("./types").IncidentCase;
export function removeCaseNote(incident: import("./types").IncidentCase, noteId: string, now?: string): import("./types").IncidentCase;
export function scopeIncidentCases(cases: import("./types").IncidentCase[], storeSignature?: string): import("./types").IncidentCase[];
export function normalizeMessageId(value: unknown): string;
export function traceMessageEvidence(results: import("./types").ScanResult[], requestedMessageId: string): import("./types").MessageTraceResult | null;
...
export function buildEvidenceBundle(options: { result: import("./types").ScanResult; incidentCase?: import("./types").IncidentCase | null; comparison?: SnapshotDiffRow[]; messageTrace?: import("./types").MessageTraceResult | null; locale?: "ko" | "en"; redaction?: { identifiers?: boolean; destinations?: boolean; filePaths?: boolean; notes?: boolean }; generatedAt?: string }): Promise<{ bytes: Uint8Array; sha256: string; manifest: Record<string, unknown>; entryNames: string[] }>;
