...
export async function buildEvidenceBundle({ result, incidentCase = null, comparison = [], messageTrace = null, locale = "en", redaction = {}, generatedAt = new Date().toISOString() }, options = {}) {
