...
export function normalizeScanResult(result) {
  return {
    ...
    structured: {
      ...
      records: result.structured.records.map((record) =>
      ...
      truncated: result.structured.truncated,
    },
    correlation: {
      links: result.correlation.links.map((link) => ({
        id: link.id,
        kind: link.kind,
        ...
        offset: link.offset,
        ackStatus: link.ackStatus,
        transactionId: link.transactionId,
        confidence: link.confidence,
        evidenceRefs: link.evidenceRefs.map((ref) => ({
          id: ref.id,
          kind: ref.kind,
          file: ref.file,
          offset: ref.offset,
      ...
      counts: result.correlation.counts,
