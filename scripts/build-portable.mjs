...
function run(command, args) {
  const result = spawnSync(command, args, { cwd: repositoryRoot, encoding: "utf8", stdio: "pipe", maxBuffer: 16 * 1024 * 1024 });
...
async function main() {
  ...
  const config = {
    main: path.join(repositoryRoot, "portable", "sea-entry.cjs"),
    output: blob,
