...
test("central export sanitizer removes independent free-text and UTF-8 hex canaries from every ZIP entry", async () => {
  ...
  for (const secret of [...Object.values(canaries), foreignStoreName, foreignSemanticKey, "FOREIGN-SEMANTIC-ID-CANARY-99221", foreignFileSemanticKey, "FOREIGN/PATH/CANARY-11338.log", unicodeSecret, utf8Hex.join(" "), utf8Hex.join("")]) {
